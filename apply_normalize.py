#!/usr/bin/env python3
"""Apply country normalization to profiles.location (from normalize_plan.json)."""
...
plan = json.load(open("/root/shemalewikinew1/normalize_plan.json"))
print(f"Aplicando {len(plan)} normalizaciones...")
